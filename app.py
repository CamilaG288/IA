...
# Atualizar estoque inicial descontando reservas
estoque_atual_df = estoque_atual_df.merge(reservas_componentes, on='COMPONENTE', how='left')
estoque_atual_df['Reserva Total'] = estoque_atual_df['Reserva Total'].fillna(0)
estoque_atual_df['Estoque Disponivel'] = estoque_atual_df['Estoque Disponivel'] - estoque_atual_df['Reserva Total']
